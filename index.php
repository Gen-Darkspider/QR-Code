 ...
 */
 ...
 echo "<body style='background-color:ffffbb'>";
    
    echo "<h1>QR Code Genorator</h1><hr/>";
    ...
    if (isset($_REQUEST['data'])) { 
        ...
        QRcode::png(' UL QR Code :)', $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
    ...
    echo '<form action="index.php" method="post">
        Data:&nbsp;<input name="data" value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):' QR Code ').'" />&nbsp;
